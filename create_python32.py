...
image_name = "python-32bit"
container_name = "python32"
...
dockerfile_path = "python-32bit"  # Path to the Dockerfile
...
shutil.copytree("output/output/python-build/usr/local", "output/cpython-3.12.4-linux32")
